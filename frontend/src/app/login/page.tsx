        ...
        <div className="min-h-screen bg-zinc-950 text-white flex items-center justify-center px-6 pt-24">
            ...
            >
                <div className="text-center mb-10">
                    <h1 className="text-4xl font-black tracking-tight mb-2">Welcome <span className="text-orange-500">Back</span></h1>
                ...
                <p className="text-center mt-8 text-zinc-500 font-medium">
                    Don't have an account? <Link href="/signup" className="text-white hover:text-orange-500 transition-colors">Join the family</Link>
                </p>
